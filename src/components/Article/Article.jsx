        ...
        <section id='article' className='pt-12 sm:pt-16 md:pt-20 pb-12 bg-gradient-to-b from-sky-50 to-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 md:px-10'>
                <motion.h3
                    ...
                    className='text-4xl font-extrabold text-gray-800 text-center mb-4'>
                        ...
                        >
                            <motion.div
                                ...
                                <img
                                    src={item.image}
                                    alt={item.title}
                                    className='w-full h-[50%] object-cover rounded-2xl mb-6 transition-transform duration-500 ease-out hover:scale-105 hover:shadow-[0_8px_20px_rgba(0,150,255,0.15)]'
                                />

                                <h4 className='text-3xl font-bold mb-4 text-blue-800 leading-snug'>
                                    {item.title}
                                </h4>
